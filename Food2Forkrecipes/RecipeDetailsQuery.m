...
{
    self.responseRecipe = [[RecipeDetails alloc] init];
...
-(void)successfull
{
    ...
    NSLog(@"RecipeDetailsQuery -> Result query: %@",self.queryResponse);
    self.responseRecipe = [[RecipeDetails alloc] initWithDictionary:self.queryResponse error:nil];
